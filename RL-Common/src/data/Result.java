...
public class Result {
    ...
    public Result(BasicDBObject obj) {
        this(obj, Record.getImplicitSchema((BasicDBObject) obj.get(FIELD_REFERENCERECORD)));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.referenceRecord.equals(other.referenceRecord)) {
            return false;
        }
        if (!this.matches.equals(other.matches)) {
            return false;
        }
        if (!this.taxonomyKey.equals(other.taxonomyKey)) {
            return false;
        }
        return true;
    }
