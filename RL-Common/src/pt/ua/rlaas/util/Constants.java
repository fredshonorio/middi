...
public class Constants {
    ...
    public static class SlotPlugin {
        ...
        private final static String PREFIX = "task.plugin";
    ...
    public static class UpdateTask {
        ...
        private final static String PREFIX = "task.plugin.update";
        ...
        private final static String COMPARE_PREFIX = PREFIX + ".compare";
        public final static String COMPARE_SCHEMA = COMPARE_PREFIX + ".schema";
        ...
        private final static String EXPORT_PREFIX = PREFIX + ".export";
...
//        public final static String EXPORTPLUGIN = PREFIX + ".exportPlugin";
    ...
    public static class TransformTask {
        ...
        private final static String PREFIX = "task.plugin.transform";
    ...
    public static class CompareTask {
        ...
        private final static String PREFIX = "task.plugin.compare";
